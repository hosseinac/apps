...
<form method="post" action="/teens/register">
	...
	<table>
		...
		<tr>	
			<td><input type=text size=30 name="homeAddress"></td>
			<td><input type=text size=30 name="homeCity"></td>
			<td><input type=text size=30 name="homeZIP"></td>
			<td><input type=text size=30 name="cellularPhone"></td>	
		...
		<tr>	
			<td><input type=text size=30 name="studentEmail"></td>
			<td><input type=text size=30 name="pgFirst"></td>
			<td><input type=text size=30 name="pgLast"></td>
			<td><input type=text size=30 name="pgPhone"></td>	
			<td><input type=text size=30 name="pgEmail"></td>
		</tr>
		<tr>
