...
public class createRegistration
{
    ...
    public createRegistration(String firstName, String lastName, String grade) 
    {
	Context ctx = null;
       	Connection con = null;
        Statement stmt = null;
        ...
        try
	{
            ...
            stmt.executeUpdate("insert into register (firstName, lastName, grade) values ('"+firstName+"','"+lastName+"','"+grade+"')");
